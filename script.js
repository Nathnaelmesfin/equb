...
function validation() {
    ...
    if (fname.value.trim() == "" && lname.value.trim() == "" && phonoNumber.value.trim() == "" && amount.options[amount.selectedIndex].value == "0") {
        ...
        innerValue += `
        <div class="row">
        <div class="col-4"> ${globalFname[index]}</div>
        <div class="col-4">${globalPhone[index]}</div>
        <div class="col-4">${globalAmount[index]}</div>
      </div>
        `
...
function generate() {
    ...
    var print = `
    <div> <h1 class="text-center">Winner!!!!</h1></div>
    <div class="row">
    <div class="col-4">Full Name</div>
    <div class="col-4">Phone Number</div>
    <div class="col-4">Amount in Birr</div>
    </div>
    <div class="row">
    <div class="col-4"> ${globalFname[ran]}</div>
    <div class="col-4">${globalPhone[ran]}</div>
